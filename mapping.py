...
class Level:
    ...
    def render(self, player: player.Player, gnome: gnome.Gnome,items: items.Item):
...
class Dungeon:
    ...
    def render(self, player: player.Player, gnome: gnome.Gnome, item: items.Item):
        ...
        """
        self.dungeon[self.level].render(player,gnome,item)
